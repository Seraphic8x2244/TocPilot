...
- v0.3.5 released:
  ...
  - v0.3.4 semantic row colours are retained: update-available rows are orange, packages successfully updated in the current session are green, selected rows use normal Windows selection colours, and green clears on Refresh All or app exit.
